// Ruta: src/presentation/store/compras.store.ts
// Nota: agrupa TODAS tus entidades de la rama feat/compras-proveedores en un solo store
// (Proveedor, OrdenCompra, OrdenCompraDetalle, CotizacionProveedor), igual que el AdminStore
// de la guia agrupa products + categories + stats. Cada entidad es un "slice" dentro del mismo store.
...
interface ComprasState {
  ...
  // ── Aqui se agregaran los siguientes slices ──────────────────────────────
