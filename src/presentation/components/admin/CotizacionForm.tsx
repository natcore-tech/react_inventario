...
export function CotizacionForm({
    ...
    const {
        ...
        resolver: zodResolver(cotizacionSchema as any),
        defaultValues: {
    ...
    // Evitamos incompatibilidades de tipos en distintas versiones de react-hook-form
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                {errors.detalles && !Array.isArray(errors.detalles) && (
                    <p className="text-xs text-destructive font-medium">{(errors.detalles as any).message}</p>
                )}

                <div className="space-y-3">
                    {fields.map((field, index) => {
                        const rowError = (errors.detalles as any)?.[index];
                        ...
                        return (
                            <div key={field.id} className="flex flex-col gap-3 rounded-lg border p-3 bg-muted/20 sm:flex-row sm:items-end">
                                <div className="flex-1 space-y-1">
                                    ...
                                    <Controller
                                        control={control}
                                        name={`detalles.${index}.producto` as any}
                                        render={({ field: selectField }) => (
                                            <Select
                                                onValueChange={(value) => {
                                                    ...
                                                    if (prod && prod.precio) {
                                                        setValue(`detalles.${index}.precio_propuesto` as any, prod.precio);
                                                    }
                                                }}
                                ...
                                <div className="w-full space-y-1 sm:w-28">
                                    ...
                                    <Input
                                        ...
                                        {...register(`detalles.${index}.cantidad` as any)}
                                    />
                                    {rowError?.cantidad && (
                                ...
                                <div className="w-full space-y-1 sm:w-36">
                                    ...
                                    <Input
                                        ...
                                        {...register(`detalles.${index}.precio_propuesto` as any)}
                                    />
